...
//		k14_QueryTxt = String.format("select * from freewifi where "
...
//		k14_QueryTxt = "select * from freewifi;"; // 테이블 전체 선택
//	
//		k14_QueryTxt = "select * from freewifi where service_provider LIKE '%SKT%';"; // where절로 검색 조건 설정 
//		
		k14_QueryTxt = "select * from freewifi where inst_country = '수원시';"; // where절로 검색 조건 설정 
